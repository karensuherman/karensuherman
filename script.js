...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hi Baby", "Aku ada pertanyaan nih buat kamu hehe", "question").then(function () {
    Swal.fire("Answer honestly ya!!").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            ...
            if (result.isConfirmed) {
              Swal.fire(`${sender} love ${nama} too`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Thanks for loving me ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang does ${nama} miss ${sender}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya ${sender} miss ${nama} too, makasihhh yaa`).then(function () {
                          Swal.fire('Terakhir deh hehe').then(function () {
